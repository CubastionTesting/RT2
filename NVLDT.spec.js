...
test.only('Sales-Staff for MDT', async () => {
 ...
 /* await pageApp1.bringToFront();
  ...
  //Quote Management limit
  //await page38.locator('#ui-id-159').click();
  ...
  await page38.getByRole('link', { name: 'Approval History' }).click();
    ...
    for(let n=0;n<validApprovers1.length;n++){
      if(NVApproveruser2[n] == pageApp1 || NVApproveruser2[n] == pageApp2 || NVApproveruser2[n] == pageApp2 || NVApproveruser2[n] == pageApp2 || NVApproveruser2[n] == pageApp2 ){
    const NVApprover2 = new verfyappvr.appnew(NVApproveruser2[n]);
