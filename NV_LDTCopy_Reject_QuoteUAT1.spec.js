...
test('Sales-Staff for MDT', async () => {
  ...
  await page38.getByRole('combobox', { name: 'Product Class Combobox Field' }).fill('LDT');
  ...
  // await page38.waitForLoadState('networkidle');
  await page38.pause()
  // await page38.locator('[name="1.2"]').click();
  // await page38.getByRole('gridcell', { name: 'SWS2LB4F24L2' }).click();
  ...
  // await page38.locator('#s_1_2_70_0_icon').click();
  // await page38.getByRole('gridcell', { name: 'FEB50E22S00G' }).click();
  // await page38.getByPlaceholder('<Case Sensitive>').fill('FEB50E22S00G');
  // await page38.getByPlaceholder('<Case Sensitive>').press('Enter');await page.getByLabel('Pick Product List Applet:Query').click();
  await page38.getByRole('link', { name: 'Chassis', exact: true }).click();
  await page38.getByLabel('Chassis List Applet:New').click();
  await page38.locator('#s_1_2_70_0_icon').click();
  ...
  await page38.waitForLoadState('networkidle');
  await page38.getByPlaceholder('Sales Price', { exact: true }).fill('¥4,519,000');
  await page38.getByPlaceholder('Sales Price', { exact: true }).click();
  ...
  console.log('\n********* From Sales-Staff - LDT (Branch Limit >= -600,000  ) *****  Expected - Branch-Sales-Mgr, Branch-Head***********\n')
...
await page38.pause()
    ...
    await page38.getByPlaceholder('Sales Price', { exact: true }).click();
    await page38.pause();
    await page38.getByPlaceholder('Sales Price', { exact: true }).fill('¥3,355,200');
    await page38.getByPlaceholder('Sales Price', { exact: true }).press('Control+s');
    ...
    await page38.getByLabel('About Record Form Applet:OK').click();
    await page38.getByRole('link', { name: 'Approval History' }).click();
    console.log('\n********* From Sales-Staff - LDT (when profit amount zero ) *****  Expected - "Branch-Sales-Mgr",    "Branch-Head" **********\n')
      const validApprovers4 = jsonData.LDT[0]['Branch-limit']['Branch-Sales-Staf'];
  ...
  await page38.getByPlaceholder('Sales Price', { exact: true }).click();
  await page38.getByPlaceholder('Sales Price', { exact: true }).fill('¥100,000');
  await page38.getByPlaceholder('Sales Price', { exact: true }).press('Control+s');
  await page38.getByLabel('Quote Form Applet:Generate').click();
  ...
  await page38.getByLabel('About Record Form Applet:OK').click();
  await page38.getByRole('link', { name: 'Approval History' }).click();
  console.log('\n********* From Sales-Staff - LDT (Management Limit < -600,000 & < -400,000 ) *****  Expected - "Branch-Sales-Mgr", "Branch-Head",  "SCHQ-BizMgmt-SnrMgr",  "SCHQ-Sales-NV-Mgr", "SCHQ-SC-Head"**********\n')
  ...
  await page38.getByRole('link', { name: 'Approval History' }).click();
  await pageApp1.bringToFront();
  console.log('\n********* From Sales-Staff - LDT (If  Operating Profit Goes Up or same) for change in progress quote case*****  Expected - "Branch-Sales-Mgr","Branch-Head"************\n')
  const validApprovers2 = jsonData.LDT[2]['Managemant-limit']['Branch-Sales-Staf'];
...
//change in  Quote for If  Operating Profit Goes  down
  ...
  await page38.getByLabel('Quote Form Applet: Change In').click();
  await page38.getByPlaceholder('Sales Price', { exact: true }).click();
  await page38.getByPlaceholder('Sales Price', { exact: true }).fill('¥30,000');
  await page38.getByPlaceholder('Sales Price', { exact: true }).press('Control+s');
  await page38.getByLabel('Quote Form Applet:Generate').click();
  await page38.getByRole('link', { name: 'Approval History' }).click();
  await pageApp1.bringToFront();
  console.log('\n********* From Sales-Staff - LDT (< -600,000 & < -400,000) for change in progress quote case*****  Expected - "Branch-Sales-Mgr",  "Branch-Head",  "SCHQ-BizMgmt-SnrMgr",  "SCHQ-Sales-NV-Mgr", "SCHQ-SC-Head"**********\n')
...
test('MGR for LDT', async () => {
    ...
    await page38.getByLabel('About Record Form Applet:OK').click();
    await page38.getByRole('link', { name: 'Approval History' }).click();
    console.log('\n********* From Sales-mgr - LDT (Branch Limit >= -600,000  ) *****  Expected - Branch-Sales-Mgr, Branch-Head***********\n')
     
      const jsonData = require('./Change Sales Quotation.json');
      const validApprovers = jsonData.LDT[0]['Branch-limit']['Branch-Sales-Mgr'];
      const verfyappvr = require('./approverfunction');
      //initiating the constructor
      const SalesGPStaff = new verfyappvr.appnew(page38);
      for (let n = 0; n < validApprovers.length; n++) {
  ...
  await page38.pause()
      ...
      await page38.getByLabel('About Record Form Applet:OK').click();
      await page38.getByRole('link', { name: 'Approval History' }).click();
      console.log('\n********* From Sales-mgr - LDT (when profit amount zero ) *****  Expected - "Branch-Sales-Mgr",    "Branch-Head" **********\n')
        const validApprovers4 = jsonData.LDT[0]['Branch-limit']['Branch-Sales-Mgr'];
        const NVApproveruser4 = [pageApp1,pageApp2]
        //const verfyappvr1 = require('./approverfunction');
        //initiating the constructor
        const SalesGPStaff4 = new verfyappvr.appnew(page38);
    ...
    await page38.getByPlaceholder('Sales Price', { exact: true }).click();
    await page38.getByPlaceholder('Sales Price', { exact: true }).fill('¥54,000');
    await page38.getByPlaceholder('Sales Price', { exact: true }).press('Control+s');
    await page38.getByLabel('Quote Form Applet:Generate').click();
    const copyQuote = await page38.locator('[aria-label="Quote#"]').inputValue();
    console.log('Quote Copy 1 : ' + copyQuote);
    ...
    await page38.getByLabel('About Record Form Applet:OK').click();
    await page38.getByRole('link', { name: 'Approval History' }).click();
    console.log('\n********* From Sales-mgr - lDT (Management Limit < -600,000 & < -400,000 ) *****  Expected - "Branch-Sales-Mgr", "Branch-Head",  "SCHQ-BizMgmt-SnrMgr",  "SCHQ-Sales-NV-Mgr", "SCHQ-SC-Head"**********\n')
     
      const validApprovers1 = jsonData.LDT[2]['Managemant-limit']['Branch-Sales-Mgr'];
      const NVApproveruser02 = [pageApp1,pageApp2,pageApp2,pageApp2,pageApp2]
      // const verfyappvr1 = require('./approverfunction');
      //initiating the constructor
      const SalesGPStaff1 = new verfyappvr.appnew(page38);
    ...
    await page38.getByRole('link', { name: 'Approval History' }).click();
    await pageApp1.bringToFront();
    console.log('\n********* From Sales-mgr - lDT (If  Operating Profit Goes Up or same) for change in progress quote case*****  Expected - "Branch-Sales-Mgr","Branch-Head"************\n')
    const validApprovers2 = jsonData.LDT[2]['Managemant-limit']['Branch-Sales-Mgr'];
      const NVApproveruser2 = [pageApp1,pageApp2,pageApp2,pageApp2,pageApp2]
    const SalesGPStaff2 = new verfyappvr.appnew(page38);
    for (let n = 0; n < validApprovers2.length; n++) {
      const isApproverValid2 = await SalesGPStaff2.isValidApprover(validApprovers2[n],n);
  ...
  //change in  Quote for If  Operating Profit Goes  down
    ...
    const validApprovers3 = jsonData.LDT[2]['Managemant-limit']['Branch-Sales-Mgr'];
    const NVApproveruser3 = [pageApp1,pageApp2,pageApp2,pageApp2,pageApp2]
  //const verfyappvr1 = require('./approverfunction');
  //initiating the constructor
  const SalesGPStaff3 = new verfyappvr.appnew(page38);
