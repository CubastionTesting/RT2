...
await page.pause();
    ...
    // await page.reload();
    await page.waitForTimeout(3000);
    await page.goto('https://forcefdp-uat1.mitsubishi-fuso.com/siebel/app/edealer/jpn?SWECmd=GotoView&SWEView=Service+Account+List+View', { waitUntil: 'networkidle' });
