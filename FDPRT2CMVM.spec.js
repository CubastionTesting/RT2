...
test('payable', async () => {
    ...
    const CustomerID = await page.locator('[id="1_s_1_l_Location"]').textContent();
    ...
    await page.locator('[aria-label="業者 (買掛先)"]').click();
...
test('both', async () => {
    ...
    await pageApp3.goto('https://forcefdp-rt2.mitsubishi-fuso.com/siebel/app/edealer/jpn?', { waitUntil: 'networkidle' });
    await pageApp3.getByLabel('User ID').click( );
    await pageApp3.getByLabel('User ID').fill('D8FDFO22');
    await pageApp3.getByRole('button', { name: 'Next' }).click();
    await pageApp3.getByLabel('Password').fill('Snakamura@1');
    await pageApp3.getByRole('button', { name: 'Log on' }).click();
    ...
    const BothID = await page.locator('[id="1_s_1_l_Location"]').textContent();
    console.log("Both Id is : " + BothID);
    ...
    await page.getByPlaceholder('リスクランク').fill('A:通常顧客');
    await page.getByPlaceholder('請求発行分類').fill('経理送付');
    await page.getByRole('button', { name: '次へ' }).click();
    await page.getByRole('button', { name: '次へ' }).click();
    await page.getByRole('button', { name: '次へ' }).click();
    ...
    await page.locator('[name="s_1_1_4_0"]').fill('自動 引落');
    await page.locator('[name="s_1_1_5_0"]').fill('休日時前日');

    await page.locator('[name="s_1_1_7_0"]').fill('納車後');
    await page.locator('[aria-labelledby="MF_Payment_Term_Type2_Label_1"]').fill('日');
    await page.locator('[aria-labelledby="MF_Payment_Terms2_Label_1"]').fill('01');
    await page.locator('[aria-labelledby="MF_Payment_Method2_Label_1"]').fill('自動 引落');
    ...
    // await page.reload();
    await page.waitForTimeout(3000);
    await page.goto('https://forcefdp-rt2.mitsubishi-fuso.com/siebel/app/edealer/jpn?SWECmd=GotoView&SWEView=Service+Account+List+View', { waitUntil: 'networkidle' });
    await page.waitForTimeout(3000);
    await page.locator('[id="s_1_1_3_0_Ctrl"]').click();

    //copy row id
    await page.locator('[id="\\31 _s_1_l_Request_infoSales_approver"]').click();
    await page.getByLabel('営業承認者', { exact: true }).press('Alt+Control+k');

    var SRrowid = await page.locator('[aria-label="ロウ番号"]').textContent();
    console.log("Row id is : " + SRrowid);
    // await page.locator('[aria-label="ロウ番号"]').press("Control+c");
    ...
    await pageApp1.getByRole('button', { name: '受信箱の項目 リストアプレット:クエリー' }).click();
    await pageApp1.getByRole('gridcell', { name: 'リンク' }).click();
    await pageApp1.getByPlaceholder('<大文字と小文字を区別する>').fill(SRrowid);
    await pageApp1.getByPlaceholder('<大文字と小文字を区別する>').press('Enter');
    //await pageApp1.getByRole('gridcell', { name: 'コンボボックスフィールド' }).click();
    await pageApp1.locator('[id="1_s_1_l_Action"]').click();
    await pageApp1.locator('[id="1_Action"]').fill('承認');
    ...
    await pageApp2.getByRole('button', { name: '受信箱の項目 リストアプレット:クエリー' }).click();
    await pageApp2.getByRole('gridcell', { name: 'リンク' }).click();
    await pageApp2.getByPlaceholder('<大文字と小文字を区別する>').fill(SRrowid);
    await pageApp2.getByPlaceholder('<大文字と小文字を区別する>').press('Enter');
    //await pageApp2.getByRole('gridcell', { name: 'コンボボックスフィールド' }).click();
    await pageApp2.locator('[id="1_s_1_l_Action"]').click();
    await pageApp2.locator('[id="1_Action"]').fill('承認');
    ...
    await pageApp3.getByRole('button', { name: '受信箱の項目 リストアプレット:クエリー' }).click();
    await pageApp3.getByRole('gridcell', { name: 'リンク' }).click();
    await pageApp3.getByPlaceholder('<大文字と小文字を区別する>').fill(SRrowid);
    await pageApp3.getByPlaceholder('<大文字と小文字を区別する>').press('Enter');
    //await pageApp3.getByRole('gridcell', { name: 'コンボボックスフィールド' }).click();
    await pageApp3.locator('[id="1_s_1_l_Action"]').click();
    await pageApp3.locator('[id="1_Action"]').fill('承認');
    ...
    await pageApp4.getByRole('button', { name: '受信箱の項目 リストアプレット:クエリー' }).click();
    await pageApp4.getByRole('gridcell', { name: 'リンク' }).click();
    await pageApp4.getByPlaceholder('<大文字と小文字を区別する>').fill(SRrowid);
    await pageApp4.getByPlaceholder('<大文字と小文字を区別する>').press('Enter');
    //await pageApp4.getByRole('gridcell', { name: 'コンボボックスフィールド' }).click();
    await pageApp4.locator('[id="1_s_1_l_Action"]').click();
    await pageApp4.locator('[id="1_Action"]').fill('承認');
...
test('Vendor', async () => {
    ...
    const VendorID = await page.locator('[id="1_s_1_l_Location"]').textContent();
    ...
    await page.getByRole('navigation', { name: '第 4 レベルのビューバー' }).getByRole('link', { name: '基本情報' }).click();
    await page.locator('[aria-label="基本情報 リストアプレット:取引先情報作成"]').click();
    await page.locator('[aria-label="顧客 (売掛先)"]').click();
    await page.getByRole('button', { name: '次へ' }).click();
    ...
    await pageApp1.getByRole('button', { name: '受信箱の項目 リストアプレット:クエリー' }).click();
    await pageApp1.getByRole('gridcell', { name: 'リンク' }).click();
    await pageApp1.getByPlaceholder('<大文字と小文字を区別する>').fill(Rrowid);
    await pageApp1.getByPlaceholder('<大文字と小文字を区別する>').press('Enter');
    //await pageApp1.getByRole('gridcell', { name: 'コンボボックスフィールド' }).click();
    await pageApp1.locator('[id="1_s_1_l_Action"]').click();
    await pageApp1.locator('[id="1_Action"]').fill('承認');
    ...
    await pageApp2.getByRole('button', { name: '受信箱の項目 リストアプレット:クエリー' }).click();
    await pageApp2.getByRole('gridcell', { name: 'リンク' }).click();
    await pageApp2.getByPlaceholder('<大文字と小文字を区別する>').fill(Rrowid);
    await pageApp2.getByPlaceholder('<大文字と小文字を区別する>').press('Enter');
    //await pageApp2.getByRole('gridcell', { name: 'コンボボックスフィールド' }).click();
    await pageApp2.locator('[id="1_s_1_l_Action"]').click();
    await pageApp2.locator('[id="1_Action"]').fill('承認');
    ...
    await pageApp3.getByRole('button', { name: '受信箱の項目 リストアプレット:クエリー' }).click();
    await pageApp3.getByRole('gridcell', { name: 'リンク' }).click();
    await pageApp3.getByPlaceholder('<大文字と小文字を区別する>').fill(Rrowid);
    await pageApp3.getByPlaceholder('<大文字と小文字を区別する>').press('Enter');
    //await pageApp3.getByRole('gridcell', { name: 'コンボボックスフィールド' }).click();
    await pageApp3.locator('[id="1_s_1_l_Action"]').click();
    await pageApp3.locator('[id="1_Action"]').fill('承認');
    ...
    await pageApp4.getByRole('button', { name: '受信箱の項目 リストアプレット:クエリー' }).click();
    await pageApp4.getByRole('gridcell', { name: 'リンク' }).click();
    await pageApp4.getByPlaceholder('<大文字と小文字を区別する>').fill(Rrowid);
    await pageApp4.getByPlaceholder('<大文字と小文字を区別する>').press('Enter');
    //await pageApp4.getByRole('gridcell', { name: 'コンボボックスフィールド' }).click();
    await pageApp4.locator('[id="1_s_1_l_Action"]').click();
    await pageApp4.locator('[id="1_Action"]').fill('承認');
