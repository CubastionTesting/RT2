...
test('Sales-Staff for MDT', async () => {
  ...
  await page38.waitForLoadState('networkidle');
  await page38.getByPlaceholder('Sales Price', { exact: true }).fill('¥2,930,000');
  await page38.getByPlaceholder('Sales Price', { exact: true }).click();
  ...
  console.log('\n********* From Sales-Staff - SLDT (Branch Limit >= -600,000  ) *****  Expected - Branch-Sales-Mgr, Branch-Head***********\n')
   
    const jsonData = require('./Change Sales Quotation.json');
    const validApprovers = jsonData.SLDT[0]['Branch-limit']['Branch-Sales-Staf'];
...
await page38.pause()
    ...
    await page38.getByPlaceholder('Sales Price', { exact: true }).click();
    await page38.pause();
    await page38.getByPlaceholder('Sales Price', { exact: true }).fill('¥2,461,200');
    await page38.getByPlaceholder('Sales Price', { exact: true }).press('Control+s');
    ...
    await page38.getByLabel('About Record Form Applet:OK').click();
    await page38.getByRole('link', { name: 'Approval History' }).click();
    console.log('\n********* From Sales-Staff - SLDT (when profit amount zero ) *****  Expected - "Branch-Sales-Mgr",    "Branch-Head" **********\n')
      const validApprovers4 = jsonData.SLDT[0]['Branch-limit']['Branch-Sales-Staf'];
  ...
  await page38.getByLabel('About Record Form Applet:OK').click();
  await page38.getByRole('link', { name: 'Approval History' }).click();
  console.log('\n********* From Sales-Staff - SLDT (Management Limit < -600,000 & < -400,000 ) *****  Expected - "Branch-Sales-Mgr", "Branch-Head",  "SCHQ-BizMgmt-SnrMgr",  "SCHQ-Sales-NV-Mgr", "SCHQ-SC-Head"**********\n')
   
    const validApprovers1 = jsonData.SLDT[2]['Managemant-limit']['Branch-Sales-Staf'];
  ...
  await page38.getByRole('link', { name: 'Approval History' }).click();
  await pageApp1.bringToFront();
  console.log('\n********* From Sales-Staff - SLDT (If  Operating Profit Goes Up or same) for change in progress quote case*****  Expected - "Branch-Sales-Mgr","Branch-Head"************\n')
  const validApprovers2 = jsonData.SLDT[2]['Managemant-limit']['Branch-Sales-Staf'];
...
//change in  Quote for If  Operating Profit Goes  down
  ...
  await page38.getByRole('link', { name: 'Approval History' }).click();
  await pageApp1.bringToFront();
  console.log('\n********* From Sales-Staff - SLDT (< -600,000 & < -400,000) for change in progress quote case*****  Expected - "Branch-Sales-Mgr",  "Branch-Head",  "SCHQ-BizMgmt-SnrMgr",  "SCHQ-Sales-NV-Mgr", "SCHQ-SC-Head"**********\n')
  const validApprovers3 = jsonData.SLDT[2]['Managemant-limit']['Branch-Sales-Staf'];
...
test('MGR for MDT', async () => {
    ...
    await page38.getByLabel('About Record Form Applet:OK').click();
    await page38.getByRole('link', { name: 'Approval History' }).click();
    console.log('\n********* From Sales-mgr - SLDT (Branch Limit >= -600,000  ) *****  Expected - Branch-Sales-Mgr, Branch-Head***********\n')
     
      const jsonData = require('./Change Sales Quotation.json');
      const validApprovers = jsonData.SLDT[0]['Branch-limit']['Branch-Sales-Mgr'];
      const verfyappvr = require('./approverfunction');
      //initiating the constructor
      const SalesGPStaff = new verfyappvr.appnew(page38);
      for (let n = 0; n < validApprovers.length; n++) {
  ...
  await page38.pause()
      ...
      console.log('\n********* From Sales-mgr - MDT (when profit amount zero ) *****  Expected - "Branch-Sales-Mgr",    "Branch-Head" **********\n')
        const validApprovers4 = jsonData.SLDT[0]['Branch-limit']['Branch-Sales-Mgr'];
        const NVApproveruser4 = [pageApp1,pageApp2]
        //const verfyappvr1 = require('./approverfunction');
        //initiating the constructor
        const SalesGPStaff4 = new verfyappvr.appnew(page38);
    ...
    await page38.getByLabel('About Record Form Applet:OK').click();
    await page38.getByRole('link', { name: 'Approval History' }).click();
    console.log('\n********* From Sales-mgr - SLDT (Management Limit < -600,000 & < -400,000 ) *****  Expected - "Branch-Sales-Mgr", "Branch-Head",  "SCHQ-BizMgmt-SnrMgr",  "SCHQ-Sales-NV-Mgr", "SCHQ-SC-Head"**********\n')
     
      const validApprovers1 = jsonData.SLDT[2]['Managemant-limit']['Branch-Sales-Mgr'];
      const NVApproveruser02 = [pageApp1,pageApp2,pageApp2,pageApp2,pageApp2]
      // const verfyappvr1 = require('./approverfunction');
      //initiating the constructor
      const SalesGPStaff1 = new verfyappvr.appnew(page38);
    ...
    await page38.getByRole('link', { name: 'Approval History' }).click();
    await pageApp1.bringToFront();
    console.log('\n********* From Sales-mgr - SLDT (If  Operating Profit Goes Up or same) for change in progress quote case*****  Expected - "Branch-Sales-Mgr","Branch-Head"************\n')
    const validApprovers2 = jsonData.SLDT[2]['Managemant-limit']['Branch-Sales-Mgr'];
      const NVApproveruser2 = [pageApp1,pageApp2,pageApp2,pageApp2,pageApp2]
    const SalesGPStaff2 = new verfyappvr.appnew(page38);
    for (let n = 0; n < validApprovers2.length; n++) {
      const isApproverValid2 = await SalesGPStaff2.isValidApprover(validApprovers2[n],n);
  ...
  //change in  Quote for If  Operating Profit Goes Up down
    ...
    await page38.getByRole('link', { name: 'Approval History' }).click();
    await pageApp1.bringToFront();
    console.log('\n********* From Sales-mgr - SLDT (< -600,000 & < -400,000) for change in progress quote case*****  Expected - "Branch-Sales-Mgr",  "Branch-Head",  "SCHQ-BizMgmt-SnrMgr",  "SCHQ-Sales-NV-Mgr", "SCHQ-SC-Head"**********\n')
    const validApprovers3 = jsonData.SLDT[2]['Managemant-limit']['Branch-Sales-Mgr'];
    const NVApproveruser3 = [pageApp1,pageApp2,pageApp2,pageApp2,pageApp2]
  //const verfyappvr1 = require('./approverfunction');
  //initiating the constructor
  const SalesGPStaff3 = new verfyappvr.appnew(page38);
