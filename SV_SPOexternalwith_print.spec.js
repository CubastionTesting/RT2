...
//work order created
  ...
  await page.locator('#s_1_2_36_0_icon').click();
  ...
  await page.locator('[id="\\31 _s_1_l_MF_Supplier_BillTo_Finance_Code"]').click();
  await page.locator('#s_1_2_52_0_icon').click();
  await page.getByRole('button', { name: '取引先を選択 リストアプレット:OK' }).click();
  await page.locator('[id="\\31 _s_1_l_MF_Reason_For_Supplier"]').click();
  await page.locator('#s_1_2_48_0_icon').click();
  await page.locator('#ui-id-261').click();
  await page.getByRole('gridcell', { name: '日時フィールド' }).click();
 ...
 await page.getByPlaceholder('トータルPOコストマニュアル').click();
...
// Planned Work Completion Date/Time
  ...
  await page.getByRole('button', { name: 'ワークオーダー リストアプレット:POの作成/同期' }).click();
 ...
 await page.waitForTimeout(3000);
  ...
  await page.getByRole('button', { name: 'サービスオーダー詳細 フォームアプレット:承認依頼' }).click();
  await page.getByRole('button', { name: 'サービスオーダー詳細 フォームアプレット:外注発注完了' }).click();
  await page.getByRole('button', { name: 'サービスオーダー詳細 フォームアプレット:作業完了' }).click();

  await page.getByRole('button', { name: 'サービスオーダー詳細 フォームアプレット:発注書印刷' }).click();
  await page.getByRole('button', { name: 'サービスオーダー詳細 フォームアプレット:納品書印刷' }).click();
  await page.getByRole('button', { name: 'サービスオーダー詳細 フォームアプレット:請求書印刷' }).click();
...
//Delivery date/time
  ...
  console.log('External mechanic work order created and Job card no. :->' + Jobcardno);
