...
test('record demo', async () => {
 ...
 await page.locator('#userid').fill('D8FDFO24');
  ...
  await page.locator('#password').fill('Snakamura@');
  ...
  console.log("All browser has been opened successfully");
...
//fill job card type
  await page.locator('[id="1_INS_Product"]').fill('18：12ヵ月点検');
...
//Delivery date/time
  ...
  console.log('12-Month inspec Job card created and Job card no. :->' + Jobcardno);
  })